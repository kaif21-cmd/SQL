...
# LEETCODE Basic Aggregate Functions

#Question : 15 : Write a solution to report the movies with an odd-numbered ID and a description that is not "boring".Return the result table ordered by rating in descending order.
...
```
![image](https://github.com/user-attachments/assets/e1e63bd8-39c2-463a-b3a5-f93524abb562)
